...
export default function TokensPage() {
 ...
 className="bg-gray-800 border border-gray-600 text-gray-200 text-sm px-3 py-2 w-56 focus:outline-none focus:ring-2 focus:ring-indigo-500"
 />
 <select
 value={chain}
 onChange={(e) => setChain(e.target.value)}
 className="bg-gray-800 border border-gray-600 text-gray-300 text-sm px-3 py-2 focus:outline-none"
 >
 ...
 {error && (
 <div className="bg-red-950 border border-red-800 text-red-300 p-4 text-sm">
 ...
 <div className="w-5 h-5 bg-gray-700 shrink-0" />
 )}
 <div>
 ...
 <span className="text-xs bg-green-900/50 text-green-300 border border-green-700 px-2 py-0.5 font-bold">
 YES
 </span>
 ) : (
