...
export default function CoinPage({ params }: Props) {
 ...
 disabled={generating}
 className="text-sm px-4 py-2 bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-50"
 >
 ...
 {latest && (
 <div className="bg-indigo-50 border border-indigo-200 px-5 py-3 flex items-center justify-between flex-wrap gap-2">
